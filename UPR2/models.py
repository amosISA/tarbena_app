...
# qué sucede con las máquinas: movimientoObra, movimientoMaquinaria
# --------------------------------------------------------------------------------------------------------------------------------------
...
class Maquina(TimeStampedModel):
    ...
    incidencias = models.ForeignKey(Incidencias, blank=True, related_name='tipo_incidencia')
    capataz_responsable = models.ForeignKey(User, blank=True, null=True, limit_choices_to={'groups__name': "UPR"}, related_name='capataz_responsable')
